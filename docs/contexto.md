...
- **Seed da rede (Alfenas 7º A)**: 3 demo non-students (Ricardo prof, Cláudia sec, Bruno admin) + memberships idempotentes com update de escopo, 12 alunos no 7º A (João linkado ao user), 9 habilidades BNCC, proficiência por aluno×habilidade.
